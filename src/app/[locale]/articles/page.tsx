          ...
          <div className="flex items-center gap-3">
            {article.category && (
              <Link
                ...
                className="text-xs font-medium text-[#7afdd6] hover:text-[#b8a4ff] transition-colors"
...
export default function ArticlesPage() {
  ...
  const { data: featuredArticlesData } = api.article.getAll.useQuery({
    locale,
    status: 'PUBLISHED',
    isFeatured: true,
    limit: 3,
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`https://kayanlive.com/${locale}/articles`} />
      </Head>
      ...
      <div className="min-h-screen bg-[#2c2c2b] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          >
            ...
            <p className="text-xl text-[#888888] mb-8 max-w-2xl mx-auto" style={{ fontFamily: '"Poppins", sans-serif' }}>
              {t('page.subtitle')}
            </p>
          ...
          {/* Featured Articles */}
          {featuredArticlesData?.articles && featuredArticlesData.articles.length > 0 && (
            <motion.section
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-[#7afdd6]" style={{ fontFamily: '"Poppins", sans-serif' }}>
                  {t('listing.featuredArticles')}
                </h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredArticlesData.articles.map((article) => (
          ...
          >
            ...
            {showFilters && (
              <motion.div
                ...
                className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6 rounded-[20px] mb-6"
                style={{
                  background: 'rgba(255, 255, 255, 0.01)',
                  backdropFilter: 'blur(50.5px)',
                  WebkitBackdropFilter: 'blur(50.5px)',
                ...
                <div>
                  ...
                  >
                    ...
                    {categories?.map((category) => (
                      <option key={category.id} value={category.slug} className="bg-[#2c2c2b]">
                        {category.name}
                      </option>
                    ))}
                  </select>
          ...
          >
            ...
            {isLoading ? (
              ...
              <div className="text-center py-16">
                <div className="mb-6">
                  <Search size={64} className="mx-auto text-[#888888] opacity-50" />
                </div>
                ...
                <p className="text-[#888888] mb-8" style={{ fontFamily: '"Poppins", sans-serif' }}>
                  {t('listing.noResultsDescription')}
                </p>
                <button
                  onClick={resetFilters}

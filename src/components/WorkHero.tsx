  ...
  return (
    ...
    >
      ...
      <div className={`relative h-full transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        {/* Main "Our Work" Title - Aspect Ratio Responsive */}
        <header
        ...
        >
          <h2 id="company-tagline" className="mb-0" style={{ textTransform: 'capitalize' }}>
            ...
            >
              Built for Impact. Delivered
            </span>
            <span className="text-white" style={{ display: 'block' }}>with Precision.</span>
          </h2>
        </aside>
        ...
        >
          ...
          <p className="mb-0">&nbsp;</p>
          <p className="mb-0 font-semibold">
            This is what our work achieves: reliability under strain, scale without chaos, and presence without delay.
          </p>
        </article>

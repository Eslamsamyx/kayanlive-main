...
# CallToActionHero image optimization script using TinyPNG API
API_KEY="V4fXVCFR2PkwMXbNGq2YDHLW3XXtHXkz"
ASSETS_DIR="/Users/eslamsamy/projects/KayanLive/kayanlive-main/public/assets"
OUTPUT_DIR="/Users/eslamsamy/projects/KayanLive/kayanlive-main/public/optimized/cta-hero"

echo "🎯 Starting CallToActionHero image optimization with TinyPNG..."

# Create output directory
mkdir -p "$OUTPUT_DIR"

# Image to optimize
HERO_IMAGE="29064c5a0d86395e45b642fe4e6daf670490f723.png"
...
echo "🎉 CallToActionHero image optimization complete!"

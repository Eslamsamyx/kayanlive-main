...
# AboutOrigin pattern image optimization script using TinyPNG API
API_KEY="V4fXVCFR2PkwMXbNGq2YDHLW3XXtHXkz"
ASSETS_DIR="/Users/eslamsamy/projects/KayanLive/kayanlive-main/public/assets"
OUTPUT_DIR="/Users/eslamsamy/projects/KayanLive/kayanlive-main/public/optimized/aboutorigin"

echo "🎯 Starting AboutOrigin pattern image optimization with TinyPNG..."
...
if [ -f "$ASSETS_DIR/$PATTERN_IMAGE" ]; then
    ...
    if [ ! -z "$url" ]; then
        # Convert to WebP with quality preservation (non-aggressive)
...
echo "🎉 AboutOrigin pattern optimization complete!"
